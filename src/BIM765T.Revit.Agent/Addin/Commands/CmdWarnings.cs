...
/// <summary>
/// Quick ribbon command: show model warnings summary.
/// </summary>
[Transaction(TransactionMode.Manual)]
public sealed class CmdWarnings : IExternalCommand
{
    public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
        ...
        var request = new ToolRequestEnvelope
        {
            ...
            ToolName = ToolNames.ReviewModelWarnings,
            PayloadJson = "{}",
            Caller = "Ribbon",
